...
ordplot
tiff("total_beta_jaccard_three_pipelines.TIF", width = 600, height = 600)
d <- ordplot+ geom_point(size = 2, aes(color = sample_data(physeq)$Pipeline)) + scale_color_manual(values = c("#787878", "#ffb31a", "black", "#5c5c8a", "#918151")) +
