...
tiff("air_temp_studies.TIF", width = 4000, height = 3000, res=300)
...
theme_set(theme_bw(base_size = 18))
tiff("water_temp_studies.TIF", width = 4000, height = 3000, res=300)
...
#make figure
theme_set(theme_bw(base_size = 18))
tiff("alpha-rare.TIF", width = 4000, height = 3000, res=300)
