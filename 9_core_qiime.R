...
tiff("upset_nr.TIF", width = 600, height = 700)
...
#Change to binary per OTU
#OTU number,(binary), Total
write.csv(merger_upset,"merge_upset.csv", row.names=FALSE)
...
merge_sampandseq <- samples_andseqs_upset(merger)
...
tiff("merge_upset.TIF", width = 600, height = 700)
